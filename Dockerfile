...
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && DEBIAN_FRONTEND=noninteractive apt-get -y install \
    ...
    jq lcov libkrb5-dev libmaxminddb-dev libpcap-dev \
    libssl-dev make python3 python3-dev python3-pip ruby \ 
    screen sqlite3 swig tree unzip vim wget zlib1g-dev \
